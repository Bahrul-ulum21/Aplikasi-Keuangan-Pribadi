            ...
            <div class="content d-flex flex-column justify-content-center">
              <div class="row">
                <div class="col-md-6 icon-box" data-aos="fade-up">
                  ...
                  <h4>Transaksi</h4>
                  <p>Melakukan Transaksi, Mencatat Uang Masuk dan Uang Keluar</p>
                  </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                  <i class="bx bx-atom"></i>
                  <h4>Menampilkan Semua Saldo</h4>
                  <p>Menampilkan Semua Saldo,"Menampilkan Seluruh Saldo Yang Di Simpan Pada Aplikasi Ini"</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="400">
                  <i class="bx bx-atom"></i>
                  <h4>Menampilkan Saldo Bulanan</h4>
                  <p>Anda Juga Dapat Mengecek Saldo Bulanan Pada Aplikasi ini</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="500">
                  <i class="bx bx-atom"></i>
                  <h4>Pengeluaran Bulanan</h4>
                  <p>Menampilkan Seluruh Pengeluaran Bulanan</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="400">
                  <i class="bx bx-atom"></i>
                  <h4>Pemasukan Bulanan</h4>
                  <p>Menampilkan Seluruh Pemasukan Bulanan</p>
                </div>
              </div>
            </div>
          </div>
